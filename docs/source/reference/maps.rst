...
The type of map used to display data can be changed based on what works best for you application. 
Each map class must conform to the map interface defined in :class:`mappymatch.maps.map_interface.MapInterface`.  
...
.. autoclass:: mappymatch.maps.map_interface.MapInterface
    :members: