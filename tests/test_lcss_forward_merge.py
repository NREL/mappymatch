...
class TestLCSSMatcherForwardMerge(TestCase):
    ...
    def test_forward_merge_ending(self):
        """
        This will test that forward_merge can merge items at the end of the list
        """
        starting_list = [1, 2, 3, 4, 5]
        condition = lambda x: x > 3
    ...
    def test_forward_merge_multi_merges(self):
        """
        This will test that forward_merge works for multiple segments
        """
