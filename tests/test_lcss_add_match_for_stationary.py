...
class TestLCSSAddMatchForStationary(TestCase):
    ...
    def test_add_matches_one_stationary_point_at_beginning(self):
        ...
        stationary_index: list[StationaryIndex] = [StationaryIndex([0,0], [None,'new'])]
    ...
    def test_add_matches_one_stationary_point_at_end(self):
        ...
        # StationaryIndex( i_index: List[int], c_index: List[Any])
        stationary_index: list[StationaryIndex] = [StationaryIndex([-1,len(matches)], [None,'new'])]
    ...
    def test_add_matches_one_stationary_point_in_middle(self):
        ...
        # StationaryIndex( i_index: List[int], c_index: List[Any])
        stationary_index: list[StationaryIndex] = [StationaryIndex([-1,-1], [None,'new'])]
        ...
        stationary_index: list[StationaryIndex] = [StationaryIndex([indx, indx], [None,'new'])]
